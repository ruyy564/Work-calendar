...
@import url(https://fonts.googleapis.com/css?family=Cabin:400,700);
    ...
    @media only screen and (max-width:480px) {
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#000000;"><p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial; text-align: center;"><span style="font-size: 20px;">Мы рады, что вы выбрали «Рабочий календарь» . Теперь просто подтвердите свой адрес электронной почты ${email} и вы готовы к работе!</span></p></div>
      ...
      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
        <tr>
          <td align="center" bgcolor="#1D252C" role="presentation" style="border:none;border-radius:25px;cursor:auto;mso-padding-alt:9px 26px 9px 26px;background:#1D252C;" valign="middle">
            <a href=${link} style="display: inline-block; background: #1D252C; color: #ffffff; font-family: Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif; font-size: 22px; font-weight: normal; line-height: 27.5px; margin: 0; text-decoration: none; text-transform: none; padding: 9px 26px 9px 26px; mso-padding-alt: 0px; border-radius: 25px;" target="_blank">
              <span><span style="font-size: 22px;">Подтвердить</span></span>
            </a>
          </td>
        </tr>
      </table>
